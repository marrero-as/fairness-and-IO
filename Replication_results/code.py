"""
Replication Code for: "Predicting Educational Performance: Bridging Algorithmic Fairness 
and Inequality of Opportunity"

Developed by: 
- Marrero, A.S. (Ángel S. Marrero)
- Giovanelli, J. (Joseph Giovanelli)

Description:
This script performs the core analysis of the paper, including model training (OLS and 
Random Forest) and accuracy and fairness metric calculation (TPR Ratios).

Inputs:
- ULL_panel_data.csv: Preprocessed longitudinal student data.

USAGE NOTE: 
To switch between models, set 'use_random_forest' to True or False (line 122).

Outputs:
- Results_ols.xlsx / Results_rf.xlsx: Performance and fairness metrics. 
- TPR_Ratios_ols.png / TPR_Ratios_rf.png: Visualization of fairness results.
